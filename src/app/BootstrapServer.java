		...
		while (working) {
			try {
				...
				//KAD SE STVARNO AKTVIRA
					...
					System.out.println("removing " + serventPort);

					if (this.activeServents.contains(serventPort))
						this.activeServents.remove(serventPort);
					newServentSocket.close();
				}
